...
This document is inspired by [this post](http://freakonometrics.hypotheses.org/16449) by [Arthur Charpentier](https://twitter.com/freakonometrics). Just some plots so far. We may try something more elaborated later on.
...
```{r, echo=FALSE, ,  fig.height=12, fig.width=8, fig.align='center'}
...
```{r, echo=FALSE, ,  fig.height=12, fig.width=7, fig.align='center'}
